...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    require_csrf(app_path('admin/booking-view.php?id=' . urlencode($id)));
    $data = [
        ...
        'booked_by' => trim($_POST['booked_by'] ?? $booking['booked_by']),
        'booked_role' => trim($_POST['booked_role'] ?? $booking['booked_role']),
        'booking_channel' => trim($_POST['booking_channel'] ?? $booking['booking_channel']),
        'ip_address' => trim($_POST['ip_address'] ?? $booking['ip_address']),
    ];
